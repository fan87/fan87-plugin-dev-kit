...
public class ItemStackBuilder {
    ...
    public ItemStackBuilder updateItemMeta(Consumer<ItemMeta> consumer) {
    ...
    public ItemStackBuilder updateItemStack(Function<ItemStack, ItemStack> function) {
    ...
    public ItemStackBuilder addLore(String lore, boolean wrapLine) {
        if (wrapLine)  return addLore(LineWrapper.wrapLine(lore));
        return addLore(lore);
    }
